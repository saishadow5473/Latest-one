...
class VariantBannerWidget {
  static Widget bannerWidget(
    ...
    return GetBuilder<BannerChallengeController>(
      ...
      builder: (_) {
        if (_.bannerChallenges.isNotEmpty) {
          return AnimatedContainer(
            ...
            width: 100.w,
            height: _.inviteVisible ? 34.5.h : 27.h,
            child: PageView.builder(
                ...
                itemBuilder: (ctx, index) {
                  ...
                  return Container(
                    margin: EdgeInsets.only(left: 6.sp, right: index != 0 ? 6.sp : 0),
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        GetBuilder<BannerChallengeController>(
                            id: 'challengeUpdate',
                            builder: (_) {
                              return AnimatedContainer(
