...
class DashBoardHealthChallengeWidget {
  ...
  Widget upcomingChallengeWidget(BuildContext context) {
      ...
      builder: (_) {
        try {
          return (_.loading)
              ...
              : _.upComingDetails.enrolChallengeList.length > 0
                  ? Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                TeleConsultationWidgets().viewAll(
                                    onTap: () => Get.to(EnrolledChallengesListScreen(
                        ...
                        Padding(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              ...
                              fontSize: 15.3.sp,
                              color:
                                  UpdatingColorsBasedOnAffiliations.affiColorCode.value == null ||
