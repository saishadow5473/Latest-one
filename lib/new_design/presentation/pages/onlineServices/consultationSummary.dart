              ...
              : Padding(
                  ...
                  child: Column(
                      ...
                      children: <Widget>[
                        ...
                        summaryDescriptionDetails(
                            'Payment Mode', appointmentSummaryDetails.message.modeOfPayment),
                        SizedBox(height: 1.5.h),
                        // summaryDescriptionDetails(
                        ...
                        if (prescriptionsList.isNotEmpty)
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              summaryDescriptionDetails('Notes', prescriptionsList.first.medNote),
                              SizedBox(height: 1.5.h),
                              Column(
                                children: prescriptionsList.map((PrescriptionModel e) {
                                  return Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      // Text((prescriptionsList.indexOf(e) + 1).toString()),
                                      SizedBox(height: 1.h),
                                      summaryDescriptionDetails('Drug Name', e.drugName),
                                      SizedBox(height: 1.h),
                                      // summaryDescriptionDetails('Quantity', e.quantity),
                                      // SizedBox(height: 1.h),
                              ...
                              Container(
                                ...
                                width: 100.w,
                                child: Visibility(
                                  visible: (appointmentSummaryDetails.message.vendorName ==
                                              'GENIX') &&
                                          // ((prescription != null &&
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (Platform.isAndroid) {
                                          ...
                                          if (deviceInfo.version.sdkInt <= 32) {
                                            ...
                                            status = await [Permission.photos, Permission.videos]
                                                .request();
                                          }
                                          status.forEach(
                                        ...
                                        if (permissionGrandted) {
                                          ...
                                          String getPlatformData =
                                              prefs.getString(SPKeys.platformData);
...
//Below code is used to get the proper parameter type for kiosk values based on their key names ✅
  ...
  Widget summaryDescriptionDetails(String detailsLeft, String detailsRight) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: <Widget>[
        SizedBox(
