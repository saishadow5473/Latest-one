...
class ManageHealthScreenTabs extends StatefulWidget {
  const ManageHealthScreenTabs({Key key}) : super(key: key);
...
class _ManageHealthScreenTabsState extends State<ManageHealthScreenTabs>
  ...
  void initState() {
    gTabBarController = TabController(
      ...
      length: 3,
      // length: 2,
      initialIndex: indexFromStepCounter,
    );
    gTabBarController.addListener(() {
      selectedIndex = gTabBarController.index;
                                        ...
                                        Text(
                                          ...
                                          style: TextStyle(
                                              ...
                                              color: selectedIndex == 2
                                                  ...
                                                  : Colors.black,
                                              fontWeight:
                                                  selectedIndex == 2 ? FontWeight.bold : null,
                                              letterSpacing: 0.4),
                                        )
                                      ],
                                    ),
