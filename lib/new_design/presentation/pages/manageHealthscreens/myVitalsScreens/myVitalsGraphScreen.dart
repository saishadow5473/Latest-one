...
class _MyVitalGraphScreenState extends State<MyVitalGraphScreen> {
  ...
  void getInitialData() async {
    ...
    selectedType.notifyListeners();
    List<dynamic> yearlyValue = await MyvitalsGraphData().getVitalsdata(
        DateTime(currentday.year - 1, 1, 1),
        DateTime(currentday.year - 1, 12, 31),
              ...
              child: Column(
                children: [
                  ...
                  if (smallWord != "BMR" && smallWord != "ECG" && smallWord != "WEIGHT")
                    Container(
                      color: vitalType == "spo2" && widget.data["status"].toString() == "Low"
                          ? colorForStatus("High").withOpacity(0.2)
                          : colorForStatus(widget.data["status"].toString()).withOpacity(0.2),
                      width: 100.w,
                      height: 11.h,
                      child: Row(
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: Column(
                              ...
                              children: [
                                FittedBox(
                                  child: Text(
                                    "Your ${vitalsUI[vitalType]["name"]} is ${widget.data["value"]} ${ProgramLists.vitalsUnitG[vitalType]}",
                                    style: TextStyle(letterSpacing: 0.1, fontSize: 14.2.sp),
                                  ),
                                ),
                                ...
                                Wrap(
                                  children: [
                                    Text("Status : ",
                                        style: TextStyle(letterSpacing: 0.3, fontSize: 15.sp)),
                                    SizedBox(
                                      width: 40.w,
                                      child: Text(
                                        widget.data["status"].contains('Doctor Attention Needed')
                                            ? 'Clinical Screening Recommended'
                                            : widget.data["status"].toString().capitalizeFirst,
                                        maxLines: 3,
                                        style: TextStyle(
                                            color: widget.data["status"]
                                                    .contains('Doctor Attention Needed')
                                                ? const Color.fromARGB(255, 216, 163, 4)
                                                : widget.data["status"].toString() == "Low" &&
                                                        vitalType == 'spo2'
                                                    ? colorForStatus("High")
                                                    : colorForStatus(
                            ...
                            child: Align(
                              ...
                              child: SizedBox(
                                ...
                                child: ClipPath(
                                  ...
                                  child: Container(
                                      color: widget.data["status"].toString() == "Low" &&
                                              vitalType == 'spo2'
                                          ? colorForStatus("High")
                                          : colorForStatus(widget.data["status"].toString())),
                                ),
                              ),
                            ),
                          )
                                    ...
                                    ? Column(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Visibility(
                                              visible: vitalsUI[vitalType]['acr'] == 'BMI',
                                              child:
                                                  statusInfo(title: 'Normal', value: "18.5-22.9")),
                                          Visibility(
                                              visible: vitalsUI[vitalType]['acr'] == 'BMI',
                                              child: SizedBox(height: 10.px)),
                                          Visibility(
                                    ...
                                    : vitalsUI[vitalType]['acr'] == 'SPO2'
                                        ...
                                        : vitalsUI[vitalType]['acr'] == 'PROTEIN'
                                            ? _vitallownrmlHignProteinStatus(
                                                ...
                                                min: 0.0,
                                                interval: 5.0,
                                                max: double.parse(gproteinh.toString()) + 10.0,
                                                low: double.parse(gproteinl.toString()),
                                                high: double.parse(gproteinh.toString()))
                                                ...
                                                ? Column(
                                                    ...
                                                    children: <Widget>[
                                                        ...
                                                        child: SfLinearGauge(
                                                            ...
                                                            ranges: <LinearGaugeRange>[
                                                              ...
                                                              LinearGaugeRange(
                                                                ...
                                                                endValue: 239,
                                                                color:
                                                                    colorForStatus('Border Line'),
                                                              ),
                                                              LinearGaugeRange(
                                                                startValue: 239,
                                                                endValue: vitalValue > 400
                                                                    ? (vitalValue.toInt() + 5)
                                                                        .toDouble()
                                                                    : 400,
                                                                color: colorForStatus('Obese'),
                                                      ...
                                                      statusInfo(
                                                          ...
                                                          twoValues: true,
                                                          value2: "239",
                                                          color: colorForStatus('Border Line')),
                                                      statusInfo(
                                                          title: "High",
                                                          value: "240",
                                                          color: colorForStatus('Obese'),
                                        ...
                                        (String e) => InkWell(
                                            onTap: () async {
                                              ...
                                              if (selectedType.value == 'Monthly') {
                                                ...
                                                String firstDayString1 = DateFormat('yyyy-MM-dd')
                                                    .format(DateTime(DateTime.now().year,
                                                        DateTime.now().month, 1));
                                                String lastDayString1 = DateFormat('yyyy-MM-dd')
                                                    .format(DateTime(DateTime.now().year,
                                              ...
                                              if (selectedType.value == 'Last 7 days') {
                                                ...
                                                firstDayString =
                                                    dateFormat.format(firstDayofLastSevendays);
                                                lastDayString =
                                                    dateFormat.format(seventhDayofLastSevendays);
                                                mapData = await MyvitalsGraphData().getVitalsdata(
                                                    DateTime.parse(firstDayString),
                                                    DateTime.parse(lastDayString),
                                                    vitalsUI[widget.data["vitalType"]]["acr"]);
                                              ...
                                              if (selectedType.value == 'Yearly') {
                                                String firstDayString1 = DateFormat('yyyy-MM-dd')
                                                    .format(DateTime(currentday.year, 1, 1));
                                                String lastDayString1 = DateFormat('yyyy-MM-dd')
                                                    .format(DateTime(currentday.year, 12, 31));
                                                firstDayString = firstDayString1;
                                                lastDayString = lastDayString1;
                                                mapData = await MyvitalsGraphData().getVitalsdata(
                                                    DateTime.parse(firstDayString1),
                                ...
                                ValueListenableBuilder(
                                    ...
                                    builder: (BuildContext context, bool value, Widget widget) {
                                      return Row(
                                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          children: [
                                            if (NewMyVitalGraph.loader != true && value != true)
                                              InkWell(
                                                  onTap: () async {
                                                    forward--;
                                                    modifyList('backward');
                                        ...
                                        builder: (__, val, _) {
                                          return SizedBox(
                                            ...
                                            child: widget.data["vitalType"] == "bp"
                                                ? NewMyVitalGraph()
                                                    .createBPChart(data: mapData.reversed.toList())
                                                : NewMyVitalGraph().createChart(
                                                    data: mapData.reversed.toList(),
                                                    vitalName: widget.data["vitalType"]),
                                          );
                                        }),
                                SizedBox(height: 3.h),
                                  ...
                                  ...mapData.reversed.map((e) {
                                    ...
                                    if (!isMoreInfoNull) {
                                      if (e["kiosk_info"]["City"] != null &&
                                          e["kiosk_info"]["City"].toString().toLowerCase() !=
                                              "na") {
                                    ...
                                    if (!isMoreInfoNull) {
                                      if (e["kiosk_info"]["Address1"] != null &&
                                          e["kiosk_info"]["Address1"].toString().toLowerCase() !=
                                              "na") {
                                      ...
                                      if (address == '' && !isMoreInfoNull) {
                                        if (e["kiosk_info"]["Address2"] != null &&
                                            e["kiosk_info"]["Address2"].toString().toLowerCase() !=
                                                "na") {
                                                              ...
                                                              if (widget.data["vitalType"] ==
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: TextButton(
                                                                    onPressed: () async {
                                                                      var data =
                                                                          await MyvitalsGraphData()
                                                                              .getEcgGraph(
                                                                                  e['Checkin_id']);
                                                                      ECGCalc ecgGraphData =
                                                                          ECGCalc(
                                                                        isLeadThree:
                                                                            e['leadmode'] == 3,
                                                                        data1: data['ECGData'],
