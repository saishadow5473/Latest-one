    ...
    return WillPopScope(
      ...
      child: CommonScreenForNavigation(
          appBar: AppBar(
            ...
            title: Padding(padding: EdgeInsets.only(left: 15.w), child: Text("Edit meal")),
                                                          ...
                                                          MaterialButton(
                                                              ...
                                                              onPressed: () {
                                                                if (_quantityForm.currentState
                                                                  ...
                                                                  // quantity =
                                                                  //     valueText;
                                                                  if (!QuantityList.quantityList.value
                                                                      .contains(valueText)) {
                          ...
                          children: [
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                  ...
                                  width: 8.w,
                                  decoration:
                                  BoxDecoration(shape: BoxShape.circle, color: widget.baseColor),
                                  child: Center(
                                    child: Text(
                                      '+',
                                            ...
                                            children: [
                                              ...
                                              InkWell(
                                                onTap: () async {
                                                  ...
                                                  nutrionslist
                                                      .addAll({'serving_unit_size': e.amount_unit});
                                              ...
                                              InkWell(
                                                  onTap: () {
                                                    ...
                                                    RemoveIngredient.removedIngredients.add(e.item);
                                                    ingredientStore();
                                                    setState(() {});
                                                  },
                                                  child: Icon(
