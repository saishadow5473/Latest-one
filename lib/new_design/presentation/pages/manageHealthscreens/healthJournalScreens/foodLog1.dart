    ...
    return WillPopScope(
      ...
      child: CommonScreenForNavigation(
        ...
        appBar: AppBar(
          ...
          title:
              Padding(padding: EdgeInsets.only(left: 15.w), child: Text("Log ${widget.mealType}")),
                        ...
                        : Padding(
                            ...
                            child: Card(
                                ...
                                child:
                                  ...
                                  SizedBox(
                                      height: logedFood.status.length > 3
                                          ? 35.h
                                          : logedFood.status.length == 1
                                              ? 16.h * logedFood.status.length
                                              : logedFood.status.length == 2
                                                  ? 12.h * logedFood.status.length
                                                  : 10.h * logedFood.status.length,
                                      child: ListView.builder(
                                          ...
                                          itemBuilder: (BuildContext cntx, int index) {
                                            ...
                                            return GetBuilder<ClendarController>(
                                                init: ClendarController(),
                                                id: "deleteFoodList",
                                                builder: (ClendarController deleteLogAll) {
                                                  ...
                                                  // });
                                                  return Visibility(
                                                    visible: logedFood.resultMap['mealCategory'] ==
                                                        widget.mealType,
                                                    child: Column(
                                                      children: [
                                                        SizedBox(
                                                        ...
                                                        deleteLogAll.deletelog.value &&
                                                                logedFood.status.length - 1 == index
                                                            ? Container(
                                                                height: 9.h,
                                                                width: 100.w,
                    ...
                    child: Card(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          //     ?
                          logedFood.foodLogHistory != null
                              ? logedFood.foodLogHistory.isEmpty
                                  ? SizedBox(
                                      height: 12.h,
                                      child: Center(
                                                ...
                                                onTap: () {
                                                  if (_navigate.value) {
                                                    if (logedFood.foodLogHistory[index].food[0]
                                                        ...
                                                        20) {
                                                      Get.to(EditFoodLog(
                                                        foodId: logedFood.foodLogHistory[index]
                                                            .food[0].foodDetails[0].foodId,
                                                        mealType: widget.mealType,
                                                        mealData: widget.mealData,
                                                        logedData: logedFood.foodLogHistory[index],
                                                        bgcolor: widget.bgColor,
                                                        foodLogId: logedFood
                                                            .foodLogHistory[index].foodLogId,
                                                      ));
                                                    } else {
                  ...
                  child: Column(
                    ...
                    children: [
                                ...
                                child: Row(
                                  children: [
                                    Text(
                                      "View All ",
                                      style: TextStyle(
                                        color: recentList.isNotEmpty ? widget.bgColor : Colors.grey,
                                        fontSize: 15.sp,
                                      ),
                                    ),
                                    Icon(
                      ...
                      recentList.isNotEmpty
                          ? SizedBox(
                              height: recentList.length > 4 ? 6.5.h * 4 : 6.5.h * recentList.length,
                              child: ListView.builder(
                                  physics: const NeverScrollableScrollPhysics(),
                                  itemCount: recentList.length > 4 ? 4 : recentList.length,
                                  itemBuilder: (BuildContext cntx, int index) {
                                    List<String> splitedTxt = recentList[index].quantity.split("|");
                                    return ListTile(
                                      onTap: () {
                                        if (_navigate.value) {
                                          if (recentList[index].foodItemID.length < 20) {
                                            String selectedDateTemp;
                                            ...
                                            Get.to(FoodDetailScreen(
                                                ...
                                                baseColor: widget.bgColor,
                                                foodId: recentList[index].foodItemID,
                                                mealType: widget.mealType,
                                                logDate: _selectedDay.runtimeType == DateTime
                                                    ? selectedDateTemp
                                                    : _selectedDay == null
                                            ...
                                            Get.to(CustomeFoodDetailScreen(
                                              foodName: recentList[index].title,
                                              foodId: recentList[index].foodItemID,
                                              mealType: widget.mealType,
                                              mealData: widget.mealData,
                                              baseColor: widget.bgColor,
