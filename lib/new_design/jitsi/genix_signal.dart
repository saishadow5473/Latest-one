...
class _GenixSignalState extends State<GenixSignal> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
        ...
        onWillPop: () {
          if (declineCall) {
            TabBarController().updateSelectedIconValue(value: AppTexts.onlineServices);
            Get.to(MultiBlocProvider(providers: <BlocProvider<dynamic>>[
              BlocProvider<TrainerBloc>(create: (BuildContext context) => TrainerBloc()),
              BlocProvider<OnlineClassApiBloc>(
                  create: (BuildContext context) =>
                      OnlineClassApiBloc()..add(OnlineClassApiEvent<String>(data: "specialty"))),
              BlocProvider<StreamOnlineClassApiBloc>(
                  create: (BuildContext context) => StreamOnlineClassApiBloc()
                    ..add(StreamOnlineClassApiEvent<String>(data: "subscriptionDetails"))),
