class AppTexts {
  ...
  static const String logActivityText = "Log Activity";
  static const String yourInsightTex = "Your Insights";
  static const String setAlarmText = "Set Alarm";
  static const String enterNoText = "Enter the number of";
  static const String askForRemainder = "Do you want to set remainder alarm for this challenge?";
  static const String program = "Programs we offer";
  static const String customize = "Customize";
  static const String onlineServices = "Online Services";
  static const String onlineClass = "Online Class";
  static const String onlineClassWelcomeText =
      "Explore our latest sessions. Subscribe and start your wellness journey.";
  static const String manageHealth = "Manage Health";
  static const String memberService = "Member Services";
  static const String todaysConsultation = "Today's Consultation";
  static const String consultation = "Teleconsultations";
  static const String specialities = "Our Specialities";
  static const String classText = "Our Classes";
  static const String doctor = "Our Doctors";
  static const String MyAppointments = "Appointments";
  static const String MyMedicalFiles = "Medical Records";
  static const String mySubscription = "My Subscription";
  static const String ratings = "Rating";
  static const String healthProgramms = "Health Programs";
  static const String Social = "Social";
  static const String welcomeUser = "Welcome ";
  static const String toIHL = "to IHL !!!";
  static const String askScore = "Need to know your health score?";
  static const String askToTest = "Take a test from our H-pod located nearest to you";
  static const String scoreText = "Your IHL Score is ";
  static const String challengeText = "Challenges";
  static const String healthTipText = "Health Tip";
  static const String newsLetterText = "News Letter";
  static const String myVitals = "Vitals";
  static const String teleconsultation = "Tele Consultation";
  static const String personal = "Personal";
  static const String affiliattion = "Affiliations";
  static const String normalStatus = "Normal";
  static const String fahrenheit = "°F";
  static const String newChallenge = "New Health Challenges";
  static const String askToJoin = "Want to be fit and healthy?";
  static const String improveHeartHealth = 'Need to improve your Heart Health?';
  static const String deservesHeartHealth =
      '"Your heart deserves the best - answer our questionaire to help us tailor our recommendations to you."';
  static const String joinDescription =
      "Join in our new IHL 8K Run Challenge and win badges and certificates.";
  static const String healthChallengeWelcomeText =
      "Keen on adopting a healthier lifestyle? \n Dive into our Health Challenges \n to keep you motivated and on track.";
  static const String healthChallengeDescription =
      'Join in new health challenges like step walking or weight loss challenge along with your friends and earn badges and certificates of achievement.';
  static const String healthJournalAsk = "Track your Calories";
  static const String logNow = "LOG NOW";
  static const String healthJournalDescription =
      "Monitor your daily intake of proteins, carbs, and fats. Simply log your meal - be it breakfast, lunch, snacks, or dinner.";
...
1.   Availability, Appointment, Rescheduling, Follow-up, and/or Cancellation :
  ...
  Tele-consultation is available for only users living in India only as per the latest tele-consultationguideline released by Govt of India

  Tele-consultations shall be available for any clinical consultations aligned to the tele-medicinenotification by government of India on tele-medicine.

  Tele-consultation from a specific doctor/physician shall be available subject to his/heravailability/willingness/discretion. Confirmation of your appointment with a specific doctor/physician,as per his/her availability, shall be sent to you via SMS and/or via email and/or via webportal. IHLreserves the right to reschedule or cancel an appointment without any prior notice though thecompany will communicate the cancellation or reschedule information via SMS and/or email and/orwebportal.

  The time provided for consultation to you is indicative. The actual consultation time may change depending on the consulting Doctor's discretion.

  Your consulting Physician reserves the right to provide post consultation follow-up at no additional cost.

  Consultations can be booked, rescheduled or cancelled only within the stipulated time limits mentioned below:
...
3.   Information and Documents required :
  ...
  IHL tele-consultation services are available for use for children, but the registered member for all patients under the age of 18 must be the patient’s parent or legal guardian. If you register as the parent or legal guardian on behalf of a minor, you will be fully responsible for complying with these Terms of Use.
  ...
  The information provided by you may be used for the purpose of services including analysis, research, training and disclosure (where required) to its affiliates, agents, others,and can be shared on demand with government authorities on request or in emergency situations
 
  The information provided by you can be kept with IHL indefinitely and can be used without revealing your identity.
...
4.   Equipment and connectivity requirement :
  ...
  IHL Services are not meant in any way for emergency and life-threatening conditions. It is advised to take the patient to the nearest hospital in such cases.
...
6.   Electronic Payments/ Refunds :
  ...
  IHL offer’s online mode of payment. You may use internet banking or debit/credit card or specific digital payment modes available for making payment for consultation charges. You shall be directed to our trusted payment gateway partners once you proceed to make payment of service fee.

  IHL shall not be liable in any manner whatsoever, if incorrect or inaccurate credit / debit card details or digital payment details are provided by you for making the payment of consultation fee or you use a credit/ debit card which is not lawfully owned by you or if you permit a third party to use your password or other means to access your account.

  IHL shall keep the aforesaid information confidential at all times and shall not utilize and share the same with any of the third parties unless it is an authorized third party website and/or required by law/regulation or court order.

  Refunds may be made in case a request is raised by the user by clicking the cancel button in the user dashboard on the IHL website within the stipulated deadline mentioned in the refund & cancellation table above.
  ...
  Refunds may be processed within 15 working days from the receipt of a request from you. All communications with regards to refund should be sent to info@indiahealthlink.com.

  You have the option to reschedule or cancel a booked appointment, strictly within the stipulated deadlines as mentioned in the refunds and cancellations table above.

  IHL reserves the right to modify/implement a new pricing structure at any time prior to billing you for your initial payment or for future payments.

7.   Use of Content & Copyright :

  IHL owns the website as well the intellectual property contained thereon including all programs, processes, designs, software, technologies, trademark, trade names, inventions and materials therein and all the services offered by the doctors/physicians or others on the website.

  You shall not use the content available on the website without the prior written permission of IHL.

8.   Privacy and Security :

  IHL uses secure encryption technology to keep your information safe and secured at all times. IHL is committed towards maintaining the privacy of the information uploaded by you on the website and complies with the industry standard security safeguards for the purpose of securing the website and the information provided/uploaded by you.

  IHL uses all reasonable endeavors to ensure the integrity of the online payment facility’s security. Despite our endeavors, breaches of security and confidentiality could occur. You acknowledge that we are not liable for any loss suffered by you as a result of any breaches in security.

9.   Value added services from associated partners :

  IHL engages various health care service providers to provide you additional convenience. You are free to select any product or services you need if that fits to your needs.

  During the course of any service if you may come across any promotional services and you will be prompted to agree or disagree to avail the services supplied by the Associated Vendors by providing your explicit consent.

  Upon your acceptance and willingness to avail associated vendor services, IHL reserves the right to share your entire prescription, personal details to the vendor to contact you for fulfillment of services. And you agree to provide the rights to the associated service vendor to contact you on the provided contact details mobile number or email address or both.
...
11.   Disclaimer :
  ...
  IHL provides the services on “as is” basis and expressly disclaims all representations, warranties or conditions of any kind, either expressed or implied, as to the operations of the website, the information, content, service provided through or in connection with the website.

  In no event shall IHL be responsible for any third party misuse for the data and for any acts, deeds and circumstances beyond the control of the management of IHL.
 
  You agree and acknowledge that you are solely responsible for your conduct.
...
13.   Termination :
  ...
  IHL reserves the right to take down your profile as well as the right to access your profile in case IHL finds feedback from doctors of any unlawful conducts, abusive languages, and misconduct during the consultation process display, with or without notice to the concerned practitioner.

14.   Modification of Terms and Conditions of Service :

  IHL may at any time, without any prior notification to you, modify these terms of conditions.
...
15.   General Terms and Conditions :
  ...
  This agreement shall be governed by the laws of India and shall be subject to the exclusive jurisdiction of the courts at New Delhi and

  IHL makes no representation that the services are appropriate for patients in any other location except India as IHL operates and controls these websites from India.
  ...
  You acknowledge that the relationship created through your use of this website shall be of principal to principal. You shall not represent yourself as a representative agent or employee of IHL.
