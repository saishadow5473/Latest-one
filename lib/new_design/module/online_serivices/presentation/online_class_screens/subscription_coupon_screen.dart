...
class _SubscriptionCouponPageState extends State<SubscriptionCouponPage> {
            ...
            child: Column(
              children: [
                ...
                InkWell(
                  ...
                  //       : (double.parse(widget.doctorDetails.consultationFees.toString()) / 1.18)
                  //       .toStringAsFixed(2);
  ...
  //     'fees': widget.doctorDetails.consultationFees.toString(),
  ...
  //       "consultation_fees":
  //       widget.doctorDetails.affilationExcusiveData.affilationArray[0].affilationPrice != "none"
  ...
  //       "reason_for_visit": widget.purposeDetails["reason"],
  //       "notes": "",
  //       "document_id": widget.purposeDetails["document_id"],
