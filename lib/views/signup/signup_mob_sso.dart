...
import 'package:ihl/views/signup/signup_alternate_email.dart';
import 'package:ihl/views/signup/signup_verify_sso.dart';
...
class SignupMobSso extends StatefulWidget {
  @override
  _SignupMobSsoState createState() => _SignupMobSsoState();
}

class _SignupMobSsoState extends State<SignupMobSso> with TickerProviderStateMixin {
                ...
                if (userExistR == false) {
                  if (this.mounted) {
                    setState(() {
                      ...
                      Get.to(SignupVerifyMobSso(mobileNumber: mobController.text.toString()));
                    });
                  }
                }
              });
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            leading: IconButton(
              ...
              onPressed: () => Get.to(SignupAlternateEmailSso(
                loginSso: false,
              )),
              color: Colors.black,
            ),
                    ...
                    child: Container(
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 1 * SizeConfig.heightMultiplier),
                          Padding(
                            padding: EdgeInsets.only(left: 50 * SizeConfig.widthMultiplier),
                            child: TextButton(
                              onPressed: () => Get.to(
                                  SignupVerifyMobSso(mobileNumber: mobController.text.toString())),
                              child: Text(
                                'Skip now',
                                style: TextStyle(
