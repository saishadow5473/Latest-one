...
import 'package:ihl/views/signup/signup_height_sso.dart';
import 'package:ihl/widgets/offline_widget.dart';

class SignupGenSso extends StatefulWidget {
  SignupGenSso({Key key}) : super(key: key);

  @override
  _SignupGenSsoState createState() => _SignupGenSsoState();
}

class _SignupGenSsoState extends State<SignupGenSso> {
  bool maleTap = true;
        ...
        child: GestureDetector(
          onTap: () {
            ...
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => SignupHtSso(gender: selectedGender),
              ),
            );
          },
          child: Container(
