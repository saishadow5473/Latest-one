...
import 'package:ihl/views/signup/signup_dob_sso.dart';
...
class SignupVerifyMobSso extends StatefulWidget {
  final String mobileNumber;
  final Function next;
  SignupVerifyMobSso({Key key, @required this.mobileNumber, this.next}) : super(key: key);

  @override
  _SignupVerifyMobSsoState createState() => _SignupVerifyMobSsoState();
}

class _SignupVerifyMobSsoState extends State<SignupVerifyMobSso> with TickerProviderStateMixin {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      widget.mobileNumber == "" || widget.mobileNumber == null
                          ? 'Verify your email'
                          : 'Verify your email \n and number',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        ...
                        ? Column(
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  widget.mobileNumber == "" || widget.mobileNumber == null
                                      ? 'We have sent OTP to you on $email'
                            ...
                            child: Column(
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    widget.mobileNumber == "" || widget.mobileNumber == null
                                        ? 'Please wait while we\'re sending OTP on $email'
