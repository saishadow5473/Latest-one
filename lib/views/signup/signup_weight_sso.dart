...
import 'package:ihl/views/signup/signup_pic.dart';
import 'package:ihl/views/signup/signup_pic_sso.dart';
...
class SignupWtSso extends StatefulWidget {
  SignupWtSso({Key key}) : super(key: key);

  @override
  _SignupWtSsoState createState() => _SignupWtSsoState();
}

class _SignupWtSsoState extends State<SignupWtSso> {
  int weight = 70;
  bool mannual = false;
