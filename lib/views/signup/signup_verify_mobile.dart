...
class SignupVerifyMob extends StatefulWidget {
  final String mobileNumber;
  final Function next;

  SignupVerifyMob({Key key, @required this.mobileNumber, this.next}) : super(key: key);

  @override
  _SignupVerifyMobState createState() => _SignupVerifyMobState();
}

class _SignupVerifyMobState extends State<SignupVerifyMob> with TickerProviderStateMixin {
                    ...
                    onPressed: () async {
                      ...
                      if (_formKey.currentState.validate()) {
                        ...
                        if (widget.next == null) {
                          ...
                          // box.write("userMobileNumber", widget.mobileNumber);
                          // var response =
                          //     await NetworkCallsAbha().checkAbhaUserOrnot(widget.mobileNumber);
                          // if (response == 'success') {
                          //   setState(() {
                          //     isLoading = false;
                          //   });
                          ...
                          //       MaterialPageRoute(builder: ((context) => AbhaLoginScreen())));
                          // }
                        ...
                        ? Column(
                            children: [
                              Padding(
                                ...
                                child: Text(
                                  'We have sent OTP to you on ${widget.mobileNumber} and $email',
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                      color: Color.fromRGBO(109, 110, 113, 1),
                                      fontFamily: 'Poppins',
                            ...
                            child: Column(
                              children: [
                                Padding(
                                  padding: const EdgeInsets.only(left: 50.0, right: 50.0),
                                  child: Text(
                                    'Please wait while we\'re sending OTP on ${widget.mobileNumber} and $email',
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                        color: Color.fromRGBO(109, 110, 113, 1),
                                        fontFamily: 'Poppins',
        ...
        onTap: () async {
          ...
          if (_formKey.currentState.validate()) {
            ...
            if (widget.next == null) {
              ...
              // var box = new GetStorage();
              // box.write("userMobileNumber", widget.mobileNumber);
              // var response = await NetworkCallsAbha().checkAbhaUserOrnot(widget.mobileNumber);
              // if (response == 'success') {
              //   setState(() {
              //     isLoading = false;
              //   });
              ...
              //   });
              //   Navigator.push(
              //       context, MaterialPageRoute(builder: ((context) => AbhaLoginScreen())));
              // }
              abhaSkipped = true;
              Navigator.of(context).pushNamed(Routes.Sdob);
            } else {
