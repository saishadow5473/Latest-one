...
class SignupGen extends StatefulWidget {
  SignupGen({Key key}) : super(key: key);

  @override
  _SignupGenState createState() => _SignupGenState();
}

class _SignupGenState extends State<SignupGen> {
  bool maleTap = true;
    ...
    Widget _customButton() {
      return Container(
        ...
        child: GestureDetector(
          onTap: () {
            SpUtil.putString('gender', selectedGender);
                          ...
                          child: Column(
                            children: [
                              Padding(
                                ...
                                child: Image.network('https://i.postimg.cc/1z5LTN7w/1996679-2.png',
                                    //https://i.postimg.cc/9FfT4BNP/img-2.pnghttps://i.postimg.cc/5NQT8HkW/1996679-1.png',
                                    height: 100,
                                    fit: BoxFit.fitWidth),
                              ),
                              Padding(
                                ...
                                child: Text(
                                  'Male',
                                  style: TextStyle(
                                    color: maleTap == true ? Colors.white : Colors.black,
                                  ),
                                ),
                              ),
                            ],
                      ...
                      InkWell(
                        ...
                        child: ClipRRect(
                          ...
                          child: Container(
                            ...
                            height: 150,
                            decoration: BoxDecoration(
                              color: femaleTap == true ? Color(0xFF19a9e5) : Colors.white,
                              //borderRadius: BorderRadius.circular(20),
                            ),
                            child: Column(
                              children: [
                                Padding(
                                  ...
                                  child: Image.network(
                                      'https://i.postimg.cc/59YMbL4m/1996681-2.png',
                                      //https://i.postimg.cc/zX9BJSmG/img-3.pnghttps://i.postimg.cc/0ysvQd5B/1996681-1.png',
                                      height: 100,
                                      fit: BoxFit.fitWidth),
                                ),
                                Padding(
                                  ...
                                  child: Text(
                                    'Female',
                                    style: TextStyle(
                                      color: femaleTap == true ? Colors.white : Colors.black,
                                    ),
                                  ),
                                ),
                              ],
