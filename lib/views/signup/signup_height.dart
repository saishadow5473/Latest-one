...
class SignupHt extends StatefulWidget {
  final String gender;

  SignupHt({Key key, @required this.gender}) : super(key: key);

  @override
  _SignupHtState createState() => _SignupHtState();
}

class _SignupHtState extends State<SignupHt> {
  int height = 170;
  double _height = 1.70;
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            leading: IconButton(
              ...
              onPressed: () => Navigator.of(context).pushNamed(Routes.Sgender),
              color: Colors.black,
            ),
            actions: <Widget>[
              Visibility(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: HeightSlider(
                    ...
                    personImagePath: widget.gender == 'm' || widget.gender == 'male'
                        ? 'assets/svgs/boy.svg'
