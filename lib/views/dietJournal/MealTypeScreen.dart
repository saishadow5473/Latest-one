...
class MealTypeScreen extends StatefulWidget {
  ...
  final bool cardioNavigate;
  final mealData;

  const MealTypeScreen({Key key, this.mealData, this.mealsListData, this.cardioNavigate})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      onWillPop: () async {
        ...
        bool ss = prefs.getBool("naviFromCardio") ?? false;
        if (ss || widget.cardioNavigate) {
                                      ...
                                      ? SizedBox(
                                          ...
                                          child: Scrollbar(
                                            ...
                                            child: ListView.builder(
                                                ...
                                                itemCount: widget.mealsListData.foodList.length,
                                                itemBuilder: (BuildContext context, int index) {
                                                  String dateTimeString =
                                                      widget.mealsListData.foodList[index].foodTime;
                                                  ...
                                                  return ListTile(
                                                    title: Text(
                                                      widget.mealsListData.foodList[index].title,
                                                      style: const TextStyle(
                                                          fontSize: 14,
                                                    ...
                                                    subtitle: Text(
                                                      widget.mealsListData.foodList[index].subtitle,
                                                      style: const TextStyle(
                                                          fontSize: 12,
                                                          fontWeight: FontWeight.w600,
                                                          letterSpacing: 0.5),
                                                  ...
                                                  child: Container(
                                                    ...
                                                    onTap: () {
                                                      if (widget.mealsListData.foodList[index]
                                                              .foodItemID.length <
                                                          20) {
                                                        Get.to(EditFoodLog(
                                                          foodId: widget.mealsListData
                                                              .foodList[index].foodItemID,
                                                          ...
                                                          foodLogId: widget.mealsListData
                                                              .foodList[index].foodLogId
                                                              .replaceRange(0, 1, ""),
                                                        ));
                                                      } else {
