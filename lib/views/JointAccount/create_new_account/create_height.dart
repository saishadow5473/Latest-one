...
class CreateHeight extends StatefulWidget {
  final String gender;
  CreateHeight({Key key, @required this.gender}) : super(key: key);

  @override
  _CreateHeightState createState() => _CreateHeightState();
}

class _CreateHeightState extends State<CreateHeight> {
  int height = 170;
  double _height = 1.70;
    ...
    Widget _customButton() {
      return Container(
        ...
        child: GestureDetector(
          onTap: () {
            SpUtil.putString('jHeight', _height.toString());
            Navigator.of(context).pushNamed(Routes.Cweight);
          },
          child: Container(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            leading: IconButton(
              ...
              onPressed: () => Navigator.of(context).pushNamed(Routes.Cgender),
              color: Colors.black,
            ),
            actions: <Widget>[
              TextButton(
