...
class CreateWeight extends StatefulWidget {
  CreateWeight({Key key}) : super(key: key);
...
class _CreateWeightState extends State<CreateWeight> {
  ...
  var jEmailGiven = SpUtil.putBool(SPKeys.jEmailGiven, true);
    ...
    Widget _customButton() {
      return Container(
        ...
        child: GestureDetector(
          onTap: () {
            if (mannual == false) {
              SpUtil.putString(SPKeys.jWeight, weight.toString());
              // Navigator.of(context).pushNamed(Routes.CAff);

              Navigator.of(context).pushNamed(Routes.Cpic);
              ...
              if (_formKey.currentState.validate()) {
                if (this.mounted) {
                  setState(() {
                    SpUtil.putString(SPKeys.jWeight, weightController.text);
                    // Navigator.of(context).pushNamed(Routes.CAff);
                    Navigator.of(context).pushNamed(Routes.Cpic);
                  });
                }
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            leading: IconButton(
              ...
              onPressed: () => Navigator.of(context).pushNamed(Routes.Cheight),
              // onPressed: () => Get.back(),
              color: Colors.black,
            ),
            actions: <Widget>[
