...
class CardioFamilyCvd extends StatefulWidget {
  CardioFamilyCvd({Key key}) : super(key: key);

  @override
  _CardioFamilyCvdState createState() => _CardioFamilyCvdState();
}

class _CardioFamilyCvdState extends State<CardioFamilyCvd> {
  bool yesTap = true;
  bool noTap = false;
  bool otherTap = false;
  Color tapped = Color(0xff56CCF2);
  Color notTapped = Colors.white;
  String selectedCvdCondition = 'n';
    ...
    Widget _customButton() {
      return Container(
        ...
        child: GestureDetector(
          onTap: () {
            SpUtil.putString('cardio_isFamilyCvd', selectedCvdCondition);
            currentIndexOfCardio.value=10;
            ///navigation to the next page where ,after checking the data from the
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: <Widget>[
          ...
          Text(
            'Please Indicate if any member of your family has Covid ?',
            textAlign: TextAlign.center,
            style: TextStyle(
                ...
                InkWell(
                  ...
                  onTap: () {
                    if (this.mounted) {
                      ...
                      setState(() => selectedCvdCondition = 'y');
                    }
                  },
                  child: Container(
                    width: 120,
                ...
                InkWell(
                  ...
                  onTap: () {
                    if (this.mounted) {
                      ...
                      setState(() => otherTap = false);
                      setState(() => selectedCvdCondition = 'n');
                    }
                  },
                  child: ClipRRect(
                    borderRadius: BorderRadius.circular(20),
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Image.asset(
                                'assets/images/cardio/no_cvd.png',
                                // child: Image.network(
