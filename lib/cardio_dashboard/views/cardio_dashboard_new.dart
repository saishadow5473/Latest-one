                ...
                Padding(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        Get.back();
                        Get.to(
                            MealTypeScreen(mealsListData: mealsListData[0], cardioNavigate: true));
                      }),
                ),
              ],
            ));
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        Get.back();
                        Get.to(
                            MealTypeScreen(mealsListData: mealsListData[1], cardioNavigate: true));
                      }),
                ),
              ],
            ));
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        Get.back();
                        Get.to(
                            MealTypeScreen(mealsListData: mealsListData[2], cardioNavigate: true));
                      }),
                ),
              ],
            ));
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        Get.back();
                        Get.to(
                            MealTypeScreen(mealsListData: mealsListData[3], cardioNavigate: true));
                      }),
                ),
              ],
            ));
              ...
              Padding(
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      print(prefs.getBool("naviFromCardio").toString());
                      Get.back();
                      Get.to(MealTypeScreen(mealsListData: mealsListData[0], cardioNavigate: true));
                    }),
              ),
            ],
          ));
              ...
              Padding(
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      print(prefs.getBool("naviFromCardio").toString());
                      Get.back();
                      Get.to(MealTypeScreen(mealsListData: mealsListData[1], cardioNavigate: true));
                    }),
              ),
            ],
          ));
              ...
              Padding(
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      print(prefs.getBool("naviFromCardio").toString());
                      Get.back();
                      Get.to(MealTypeScreen(mealsListData: mealsListData[2], cardioNavigate: true));
                    }),
              ),
            ],
          ));
              ...
              Padding(
                ...
                child: ElevatedButton(
                    ...
                    onPressed: () async {
                      ...
                      print(prefs.getBool("naviFromCardio").toString());
                      Get.back();
                      Get.to(MealTypeScreen(mealsListData: mealsListData[3], cardioNavigate: true));
                    }),
              ),
            ],
          ));
                              ...
                              child: ElevatedButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    Get.to(MealTypeScreen(
                                        mealsListData: mealsListData[index], cardioNavigate: true));
                                  }),
                            ),
                          ],
                        ),
