...
class OnlineClassApiCall {
  ...
  Future<List> getSubscriptionHistory({int endPage, String filterType}) async {
    ...
    if (response.statusCode == 200) {
      ...
      List<Subscription> filtredClassList=onlineSerivicesFunction.filterExpiredSubscriptionClass(subList);
      filtredClassList.removeWhere((Subscription element) => element.title==" "||element.courseTime==""||element.courseTime=="null");
