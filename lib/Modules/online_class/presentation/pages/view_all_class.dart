...
class ViweAllClass extends StatelessWidget {
  ...
  OnlineServicesApiCall _onlineServicesApi = OnlineServicesApiCall();
                                                    ...
                                                    Row(
                                                      ...
                                                      children: [
                                                        Text(TimeCalculation()
                                                            .getClassStartTime(e.courseTime)),
                                                        Row(
                                                          children: [
                                                            Visibility(
                                                              visible: state is FilterLoadedState
                                                                  ? state.filterType ==
                                                                          "Accepted" ||
                                                                      state.filterType ==
                                                                          "Requested"
                                                                                  ...
                                                                                  return c == false
                                                                                          ...
                                                                                          children: [
                                                                                            ElevatedButton(
                                                                                              style:
                                                                                                ...
                                                                                                shape:
                                                                                                    RoundedRectangleBorder(borderRadius: BorderRadius.circular(10.0), side: BorderSide(color: isloading.value ? Colors.grey : AppColors.primaryColor)),
                                                                                              ),
                                                                                              onPressed:
                                                                                                  () {
                                                                                                isReasonFiled.value =
                                                                                              ...
                                                                                              child:
                                                                                                ...
                                                                                                'Go Back',
                                                                                                style:
                                                                                                    TextStyle(color: isloading.value ? Colors.blue : Colors.white),
                                                                                              ),
                                                                                            ),
                                                                                            ValueListenableBuilder(
                                                                                                valueListenable:
                                                                                                ...
                                                                                                builder: (_,
                                                                                                  ...
                                                                                                  return ElevatedButton(
                                                                                                    style: ElevatedButton.styleFrom(
                                                                                                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10.0), side: const BorderSide(color: AppColors.primaryColor)),
                                                                                                      backgroundColor: field ? AppColors.primaryColor : Colors.grey,
                                                                                                    ),
                                                                                                    onPressed: field
                                                                                                        ? () async {
                                                                                                            isReasonFiled.value = false;
                                                                                                            isloading.value = true;
                                                                                                            dynamic msg = await CancelSubscription().cancelSubscription(e.subscriptionId, "user", textValue, e.provider.toString());
                                                                                                            try {
                                                                                                              await _onlineServicesApi.updateUserDetails();
                                                                                                              subSrciptionFilterBloc.add(FilterSubscriptionEvent(filterType: "Accepted", endIndex: 10));
                                                                                                            } catch (e) {
                                                                                      ...
                                                                                      : Center(
                                                                                          child: ElevatedButton(
                                                                                              style: ElevatedButton.styleFrom(
                                                                                                shape:
                                                                                                    RoundedRectangleBorder(borderRadius: BorderRadius.circular(10.0), side: const BorderSide(color: AppColors.primaryColor)),
                                                                                                backgroundColor:
                                                                                                    Colors.grey,
                                                                                              ),
                                                                                              onPressed: null,
