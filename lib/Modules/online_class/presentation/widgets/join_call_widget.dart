...
class joinCallwidget extends StatelessWidget {
            ...
            return Row(
              ...
              children: [
                ...
                noTime
                    ...
                    : Text(
                        formatedClassDuration,
                        style: TextStyle(fontSize: 14.sp, color: AppColors.primaryAccentColor,fontWeight: FontWeight.bold),
                      ),
                noTime
                    ? Container()
                    : SizedBox(
  ...
  bool isTenMinsBefore(String timeRange) {
    ...
    DateTime after15 = targetTime.add(const Duration(minutes: 15));
...
//&& currentTime.isBefore(targetTime)
  ...
  bool isAfterHours(String timeRange) {
    ...
    if (tenMinutesAgo.isAfter(targetTime)) {
      return true;
    } else {
      return false;
    }
